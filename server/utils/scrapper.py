...
existing_urls = set()  # Initialize an empty set for existing URLs
urls = ['https://www.saatva.com/mattresses', 'https://www.saatva.com/furniture', 'https://www.saatva.com/bedding', 'https://www.saatva.com/gifts']
for url in urls: 
